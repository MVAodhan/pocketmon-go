...
import PokemonCard from './my-components/pocketmon-card'
...
export default function Home() {
  ...
  return (
    <main className="flex w-screen min-h-screen justify-center items-center font-[family-name:var(--font-geist-sans)] ">
      <div>
        <div className="grid grid-cols gap-2 justify-center my-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 self-start">
          {pocketmon.map((item) => (
            <div key={item.id}>
